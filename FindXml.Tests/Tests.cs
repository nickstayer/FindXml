...
public class Tests
{
    ...
    [TestCase(
        ...
        "Загрузка завершилась ошибкой: ГИСМУ-Регистрационный учет-0016: В заявлении не был передан GUID адреса",
        @"C:\test\result\Файлы переданные в Регистрационный учет\Обработанные с ошибкой\Нет GUID адреса\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Миграционный учет",
        "Обработанные с ошибкой",
        "Ошибка ФЛК: Срок пребывания должен быть в диапазоне 30 дней до или после даты приема уведомления",
        @"C:\test\result\Файлы переданные в Миграционный учет\Обработанные с ошибкой\Некорректный срок пребывания\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Миграционный учет",
        "Обработанные с ошибкой",
        "Невозможно создать дело на постановку на учет/снятие с учета от гостиниц: некорректный формат входного сообщения или ошибка чтения данных из файла.",
        @"C:\test\result\Файлы переданные в Миграционный учет\Обработанные с ошибкой\Невозможно создать дело\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Миграционный учет",
        "Обработанные с ошибкой",
        "ошибка ФЛК: отсутствует поле \"Адрес принимающей стороны\"",
        @"C:\test\result\Файлы переданные в Миграционный учет\Обработанные с ошибкой\Отсутствует адрес принимающей стороны\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Миграционный учет",
        "Обработанные с ошибкой",
        "-Код ошибки: МУ10009_Имя Код поля: Имя: Описание: Поле не содержит цифр и символов '~', '!', '@', '#', '\\$', '%', '^', '&', '*', '(', ')', '\"', '№', ';', ':', '?', '.'",
        @"C:\test\result\Файлы переданные в Миграционный учет\Обработанные с ошибкой\Поле не содержит цифр и символов\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
