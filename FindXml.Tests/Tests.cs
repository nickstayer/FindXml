...
public class Tests
{
    ...
    [TestCase(
        ...
        @"C:\test\result\Файлы переданные в Регистрационный учет\Конфликты\Некорретные данные физлица\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Регистрационный учет",
        "Конфликты",
        "конфликт, дело с внешним идентификатором 50FCD502-3E19-4981-AD66-7A0E3FA5DE0C не найдено в регистрационном учете",
        @"C:\test\result\Файлы переданные в Регистрационный учет\Конфликты\Дело не найдено\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Регистрационный учет",
        "Конфликты",
        " В заявлении не был передан GUID адреса",
        @"C:\test\result\Файлы переданные в Регистрационный учет\Конфликты\Нет GUID адреса\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Регистрационный учет",
        "Конфликты",
        " Ошибка при отождествлении адреса. Не указан населенный пункт / планировочная структура / улица",
        @"C:\test\result\Файлы переданные в Регистрационный учет\Конфликты\Ошибка при отождествлении адреса\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Регистрационный учет",
        "Конфликты",
        " Номер заявления 78565; Отказ подсистемы",
        @"C:\test\result\Файлы переданные в Регистрационный учет\Конфликты\Отказ подсистемы\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
    [TestCase(
        "Файлы переданные в Регистрационный учет",
        "Конфликты",
        " По данному запросу не был получен результат обработки",
        @"C:\test\result\Файлы переданные в Регистрационный учет\Конфликты\Нет результата обработки\Form5_7400000008002041_77566_ee640a9b-8fd4-4d21-b13f-209bf6f837c7.xml"
    )]
